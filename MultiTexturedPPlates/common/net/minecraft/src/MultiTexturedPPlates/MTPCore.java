...
public class MTPCore {
	...
	public static File configFile = new File(MultiTexturedPPlates.minecraftDir,
			"config/MultiTexturedPPlates.cfg");
	...
	public static void addItems() {
		...
		mtPPlate = (new BlockMTPPlate(mtPPlateBlockID,
				TileEntityMTPPlate.class, 0.5F, Block.soundStoneFootstep, true,
	...
	public static void addNames() {
		...
		ModLoader.addName(new ItemStack(mtPPlate, 1, 2),
				"Diamond Pressure Plate");
	}

	public static void addRecipes() {
		ModLoader.addRecipe(new ItemStack(mtPPlate, 1, 0),
				new Object[] { "X", "Y", Character.valueOf('X'),
						Item.ingotIron, Character.valueOf('Y'),
						Block.pressurePlatePlanks });
		ModLoader.addRecipe(new ItemStack(mtPPlate, 1, 1),
				new Object[] { "X", "Y", Character.valueOf('X'),
						Item.ingotGold, Character.valueOf('Y'),
						Block.pressurePlateStone });
		ModLoader.addRecipe(new ItemStack(mtPPlate, 1, 2),
				new Object[] { "X", "Y", Character.valueOf('X'), Item.diamond,
						Character.valueOf('Y'), Block.pressurePlateStone });
		FurnaceRecipes.smelting().addSmelting(mtPPlateBlockID, 0,
				new ItemStack(Item.ingotIron, 1));
		FurnaceRecipes.smelting().addSmelting(mtPPlateBlockID, 1,
				new ItemStack(Item.ingotGold, 1));
		FurnaceRecipes.smelting().addSmelting(mtPPlateBlockID, 2,
				new ItemStack(Item.diamond, 1));
	}

	public static int configurationProperties() {
		configuration.load();
		mtPPlateBlockID = Integer.parseInt(configuration
				.getOrCreateBlockIdProperty("mtPPlateID", 194).value);
		configuration.save();
