...
public class BlockMTLever extends BlockContainer
{
    ...
    public BlockMTLever(int var1, Class var2, float var3, StepSound var4, boolean var5, boolean var6)
    {
        super(var1, Material.ORIENTABLE);
        this.mtLeverEntityClass = var2;
        this.textureId = 4;
        this.c(var3);
        this.a(var4);
    ...
    {
        return var5 == 1 && var1.isBlockSolidOnSide(var2, var3 - 1, var4, 1) || var5 == 2 && var1.isBlockSolidOnSide(var2, var3, var4 + 1, 2) || var5 == 3 && var1.isBlockSolidOnSide(var2, var3, var4 - 1, 3) || var5 == 4 && var1.isBlockSolidOnSide(var2 + 1, var3, var4, 4) || var5 == 5 && var1.isBlockSolidOnSide(var2 - 1, var3, var4, 5);
    }
    ...
    {
        return var1.isBlockSolidOnSide(var2 - 1, var3, var4, 5) || var1.isBlockSolidOnSide(var2 + 1, var3, var4, 4) || var1.isBlockSolidOnSide(var2, var3, var4 - 1, 3) || var1.isBlockSolidOnSide(var2, var3, var4 + 1, 2) || var1.isBlockSolidOnSide(var2, var3 - 1, var4, 1);
    }
    ...
    public void postPlace(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        if (var5 == 1 && var1.isBlockSolidOnSide(var2, var3 - 1, var4, 1))
        {
        ...
        if (var5 == 3 && var1.isBlockSolidOnSide(var2, var3, var4 - 1, 3))
        {
            var6 = 3;
        }

        if (var5 == 4 && var1.isBlockSolidOnSide(var2 + 1, var3, var4, 4))
        {
            var6 = 2;
        }

        if (var5 == 5 && var1.isBlockSolidOnSide(var2 - 1, var3, var4, 5))
        {
            var6 = 1;
        }
    ...
    public void doPhysics(World var1, int var2, int var3, int var4, int var5)
    {
        if (this.checkIfAttachedToBlock(var1, var2, var3, var4))
        {
            ...
            if (!var1.isBlockSolidOnSide(var2 - 1, var3, var4, 1) && var6 == 1)
            {
                var7 = true;
            }

            if (!var1.isBlockSolidOnSide(var2 + 1, var3, var4, 2) && var6 == 2)
            {
                var7 = true;
            }
            ...
            if (!var1.isBlockSolidOnSide(var2, var3, var4 + 1, 4) && var6 == 4)
            {
                var7 = true;
            }

            if (!var1.isBlockSolidOnSide(var2, var3 - 1, var4, 5) && var6 == 5)
            {
                var7 = true;
            }

            if (!var1.isBlockSolidOnSide(var2, var3 - 1, var4, 6) && var6 == 6)
            {
                var7 = true;
            }
    ...
    public boolean interact(World var1, int var2, int var3, int var4, EntityHuman var5)
    {
        ...
        else
        {
            ...
            var1.makeSound((double)var2 + 0.5D, (double)var3 + 0.5D, (double)var4 + 0.5D, "random.click", 0.3F, var8 > 0 ? 0.6F : 0.5F);
    ...
    public void remove(World var1, int var2, int var3, int var4)
    {
        ...
        TileEntityMTLever var10 = (TileEntityMTLever)var1.getTileEntity(var2, var3, var4);
        ...
        if (var10 != null)
        {
            ...
            if (var7 > -1)
            {
                ItemStack var8 = new ItemStack(MTLCore.mtLeverItem, 1, var7);
    ...
    public TileEntity a_()
    {
        try
        {
            return (TileEntity)this.mtLeverEntityClass.newInstance();
        }
