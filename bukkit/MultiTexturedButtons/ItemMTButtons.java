...
public class ItemMTButtons extends ItemBlock
{
    private String[] buttonNames = new String[] {"Iron", "Gold", "Diamond"};
    private final Block blockRef;

    public ItemMTButtons(int var1)
    {
        super(var1);
    ...
    {
        return super.getName() + "." + this.buttonNames[var1.getData()];
    }
    ...
    public ItemMTButtons setBlockNames(String[] var1)
    {
        this.buttonNames = var1;
        return this;
    }

    public int getIconFromDamage(int var1)
    {
        return this.blockRef.a(0, var1);
    }
    ...
    {
        Block var8 = MTBCore.BlockMTButton;
        ...
        else if (var3.mayPlace(var8.id, var4, var5, var6, false, var7))
        {
            if (var3.setTypeIdAndData(var4, var5, var6, var8.id, this.filterData(var1.getData())))
            {
                if (var3.getTypeId(var4, var5, var6) == var8.id)
                {
                    ...
                    if (var9 != null && var9 instanceof TileEntityMTButton)
                    {
                        TileEntityMTButton var10 = (TileEntityMTButton)var9;
