...
import MultiTexturedButtons.network.PacketUpdateMTButton;
...
public class TileEntityMTButton extends TileEntity
{
    ...
    public void handleUpdatePacket(PacketUpdate var1, World var2)
    {
        PacketUpdateMTButton var3 = (PacketUpdateMTButton)var1;
        this.setMetaValue(var3.getItemDamage());
        this.update();
