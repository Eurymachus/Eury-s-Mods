...
public class RenderPaintings extends Render
{
    ...
    public void func_158_a(EntityPaintings par1EntityPaintings, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    private void func_159_a(EntityPaintings par1EntityPainting, int par2, int par3, int par4, int par5)
    {
    ...
    private void func_160_a(EntityPaintings par1EntityPainting, float par2, float par3)
    {
    ...
    {
        this.func_158_a((EntityPaintings)par1Entity, par2, par4, par6, par8, par9);
    }
}
