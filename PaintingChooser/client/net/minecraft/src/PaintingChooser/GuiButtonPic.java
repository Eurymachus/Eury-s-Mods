...
public class GuiButtonPic extends GuiButton
{
    ...
    public GuiButtonPic(int var1, int var2, int var3, int var4, int var5, int var6, int var7)
    {
    ...
    public void drawButton(Minecraft var1, int var2, int var3)
    {
        if (this.drawButton)
        {
            ...
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, var1.renderEngine.getTexture("/art/kz.png"));
            ...
            this.drawTexturedModalRect(this.xPosition, this.yPosition, this.p1, this.p2, this.width, this.height);
