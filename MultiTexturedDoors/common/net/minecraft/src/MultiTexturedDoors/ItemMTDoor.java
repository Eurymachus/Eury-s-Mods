...
public class ItemMTDoor extends Item implements ITextureProvider {
	...
	public String getItemNameIS(ItemStack itemstack) {
		return (new StringBuilder()).append(super.getItemName()).append(".")
				.append(doorNames[itemstack.getItemDamage()]).toString();
	}
	...
	public static void placeDoorBlock(World par0World, int par1, int par2,
			int par3, int par4, Block par5Block, int damage) {
		byte var6 = 0;
		byte var7 = 0;
		...
		int var8 = (par0World.isBlockNormalCube(par1 - var6, par2, par3 - var7) ? 1
				: 0)
				+ (par0World.isBlockNormalCube(par1 - var6, par2 + 1, par3
						- var7) ? 1 : 0);
		int var9 = (par0World.isBlockNormalCube(par1 + var6, par2, par3 + var7) ? 1
				: 0)
				+ (par0World.isBlockNormalCube(par1 + var6, par2 + 1, par3
						+ var7) ? 1 : 0);
		...
		par0World.setBlockAndMetadataWithNotify(par1, par2 + 1, par3,
				par5Block.blockID, 8 | (var12 ? 1 : 0));
		TileEntity tileentity1 = par0World.getBlockTileEntity(par1, par2 + 1,
				par3);
