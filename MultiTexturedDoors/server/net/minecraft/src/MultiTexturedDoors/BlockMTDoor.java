...
public class BlockMTDoor extends BlockContainer {
	...
	public int getBlockTexture(IBlockAccess par1IBlockAccess, int par2,
		...
		TileEntityMTDoor tileentitymtdoor = (TileEntityMTDoor) par1IBlockAccess
		...
		if (indexInTexture != -1) {
			if (par5 != 0 && par5 != 1) {
				int var6 = this
						.func_48212_i(par1IBlockAccess, par2, par3, par4);
	...
	public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess,
			int par2, int par3, int par4) {
		this.setDoorRotation(this.func_48212_i(par1IBlockAccess, par2, par3,
				par4));
	}
	...
	public void onBlockRemoval(World world, int i, int j, int k) {
		TileEntityMTDoor tileentitymtdoor = (TileEntityMTDoor) world
	...
	public int func_48212_i(IBlockAccess par1IBlockAccess, int par2, int par3,
			int par4) {
